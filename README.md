...
- The publishable boundary candidate is now sixteen exact-version crates in six dependency waves.
  ...
  exact clean `4755d58` replay packaged and compiled all sixteen extracted archives and passed its
  registry-shaped Rust 1.85 consumer. `pliego-css-lsp` was 26,644 bytes,
  `pliego-css-build` 59,910 bytes, `pliego-cssc` 61,426 bytes, and `pliego-css-control` 61,068
