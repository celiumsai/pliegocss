...
- The publishable boundary candidate is now sixteen exact-version crates in six dependency waves.
  ...
  exact clean `2e3539c` replay packaged and compiled all sixteen extracted archives and passed its
  registry-shaped Rust 1.85 consumer. `pliego-css-lsp` was 25,464 bytes,
  `pliego-css-build` 59,916 bytes, `pliego-cssc` 61,337 bytes, and `pliego-css-control` 61,071
