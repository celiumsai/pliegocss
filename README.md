...
- The publishable boundary candidate is now sixteen exact-version crates in six dependency waves.
  ...
  exact clean `2ad7a3d` replay packaged and compiled all sixteen extracted archives and passed its
  registry-shaped Rust 1.85 consumer. `pliego-css-lsp` was 26,855 bytes,
  `pliego-css-build` 59,920 bytes, `pliego-cssc` 61,356 bytes, and `pliego-css-control` 61,067
