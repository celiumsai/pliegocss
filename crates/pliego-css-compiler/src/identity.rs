...
mod tests {
    ...
    fn rich_v2_stream_digest_style_id_and_class_are_frozen() {
        ...
        assert_eq!(
            hex(&stream),
            ""
        );
        assert_eq!(
            format!("{:x}", Sha256::digest(&stream)),
            "a3ce828a00a553726c6b9322bd6b2262bcdf66215326f8754329c6452bfcf266"
        );
        assert_eq!(
            format!("{:032x}", style.id.get()),
            "a3ce828a00a553726c6b9322bd6b2262"
        );
        assert_eq!(style.id.to_class_name(), "pc_9p4ab788swo2xs7828cmvjdk2");
    }
