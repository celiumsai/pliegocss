...
mod tests {
    ...
    fn rich_v2_stream_digest_style_id_and_class_are_frozen() {
        ...
        assert_eq!(
            hex(&stream),
            ""
        );
        assert_eq!(
            format!("{:x}", Sha256::digest(&stream)),
            "0eac94fe6aa3564e4baec0da4bd90c435833a12dd102ac5a5933bebd18b9a432"
        );
        assert_eq!(
            format!("{:032x}", style.id.get()),
            "0eac94fe6aa3564e4baec0da4bd90c43"
        );
        assert_eq!(style.id.to_class_name(), "pc_v9w66clrgmavynfc64c33tqb");
    }
