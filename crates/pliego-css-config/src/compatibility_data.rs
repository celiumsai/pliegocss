...
const WEB_FEATURE_SNAPSHOTS: &[WebFeatureSnapshot] = &[
    ...
    WebFeatureSnapshot {
        id: "user-select",
        name: "user-select",
        compat_key: "css.properties.user-select",
        baseline: BaselineFeatureStatus::Limited,
        baseline_low_date: None,
        baseline_high_date: None,
        chrome: Some("54"),
    ...
    WebFeatureSnapshot {
        id: "aspect-ratio",
        name: "aspect-ratio",
        compat_key: "css.properties.aspect-ratio",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2021-09-20"),
        baseline_high_date: Some("2024-03-20"),
        chrome: Some("88"),
        edge: Some("88"),
        firefox: Some("89"),
        safari: Some("15"),
    ...
    WebFeatureSnapshot {
        id: "color-function",
        name: "color()",
        compat_key: "css.types.color.color",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2023-05-09"),
        baseline_high_date: Some("2025-11-09"),
        chrome: Some("111"),
        edge: Some("111"),
        firefox: Some("113"),
        safari: Some("15"),
    ...
    WebFeatureSnapshot {
        ...
        compat_key: "css.types.color.oklch",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2023-05-09"),
        baseline_high_date: Some("2025-11-09"),
        chrome: Some("111"),
    ...
    WebFeatureSnapshot {
        id: "color-mix",
        name: "color-mix()",
        compat_key: "css.types.color.color-mix",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2023-05-09"),
        baseline_high_date: Some("2025-11-09"),
        chrome: Some("111"),
    ...
    WebFeatureSnapshot {
        id: "color-mix-variadic",
        name: "color-mix() with three or more colors",
        compat_key: "css.types.color.color-mix.variadic_color_arguments",
        baseline: BaselineFeatureStatus::Limited,
        baseline_low_date: None,
        baseline_high_date: None,
        chrome: None,
    ...
    WebFeatureSnapshot {
        id: "focus-visible",
        name: ":focus-visible",
        compat_key: "css.selectors.focus-visible",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2022-03-14"),
        baseline_high_date: Some("2024-09-14"),
        chrome: Some("86"),
    ...
    WebFeatureSnapshot {
        id: "is",
        name: ":is()",
        compat_key: "css.selectors.is",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2021-01-21"),
        baseline_high_date: Some("2023-07-21"),
        chrome: Some("88"),
        edge: Some("88"),
        firefox: Some("82"),
        safari: Some("14"),
    ...
    WebFeatureSnapshot {
        id: "where",
        name: ":where()",
        compat_key: "css.selectors.where",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2021-01-21"),
        baseline_high_date: Some("2023-07-21"),
        chrome: Some("88"),
    ...
    WebFeatureSnapshot {
        id: "not",
        name: ":not() selector list",
        compat_key: "css.selectors.not.selector_list",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2021-01-21"),
        baseline_high_date: Some("2023-07-21"),
        chrome: Some("88"),
    ...
    WebFeatureSnapshot {
        id: "has",
        name: ":has()",
        compat_key: "css.selectors.has",
        baseline: BaselineFeatureStatus::Widely,
        baseline_low_date: Some("2023-12-19"),
        baseline_high_date: Some("2026-06-19"),
        chrome: Some("105"),
        edge: Some("105"),
        firefox: Some("121"),
        safari: Some("15.4"),
...
mod tests {
    ...
    fn policy_and_feature_snapshot_are_frozen() {
        ...
        let user_select = web_feature_snapshot("user-select").expect("user-select snapshot");
        assert_eq!(user_select.baseline, BaselineFeatureStatus::Limited);
        assert_eq!(user_select.chrome, Some("54"));
        assert_eq!(user_select.edge, Some("79"));
        assert_eq!(user_select.firefox, Some("69"));
        assert_eq!(user_select.safari, None);
        assert!(!user_select.supports_modern_profile());
    }
}
