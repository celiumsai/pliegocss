...
> Historical release record. It describes the published RC.2 tag but has no
> current promotion authority. See the schema-3
> [machine readiness record](../product/release-readiness-0.1.0.json).
