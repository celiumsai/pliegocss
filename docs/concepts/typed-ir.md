...
StyleId format 2 and its candidate vectors are machine-enforced at workspace version `0.0.0`, while
the public SemVer freeze remains open. The complete byte grammar and migration boundary are in the
