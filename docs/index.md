...
- [Shared compiler engine](./reference/engine-api.md)
...
- [0.1.0 release readiness — current generated view](./product/release-readiness-0.1.0.md)
- [0.1.0 release readiness — schema-4 machine authority](./product/release-readiness-0.1.0.json)
- [0.1.0-rc.2 hardening report — historical](./archive/releases/0.1.0-rc.2-hardening-report.md)
- [0.1.0-rc.3 candidate release notes](./releases/0.1.0-rc.3.md)
- [Historical evidence archive](./archive/README.md)
...
- [Historical Gate B complete-fixture benchmark](./benchmarks/pliego-gate-b.md)
- [Tailwind Benchmark Authority v2](./benchmarks/tailwind-benchmark-authority-v2.md)
- [Generated competitive matrix against Tailwind CSS v4.3.3](./benchmarks/tailwind-v4-competitive-matrix.md)
...
- [Browser/output certification v1](./benchmarks/browser-output-certification-v1.md)
