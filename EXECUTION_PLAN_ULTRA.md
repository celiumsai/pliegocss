...
- [ ] Crear inventarios read-only Sass, Tailwind y CSS Modules sin prometer migración perfecta. La
  ...
  con expresión como dynamic. El crawling de proyecto y la resolución Sass relativa de
  archivos/partials/index/import-only ya están implementados; faltan load paths/importers, bundlers e
...
- [ ] Entrevistar 10–15 developers/equipos y reunir 20 incidentes reales anonimizados. G7 ya tiene
  ...
  verificador fail-closed y política de adapters 0.1.x congelada. La convocatoria pública está
  abierta en `https://github.com/celiumsai/pliegocss/issues/7` y el preparador local liga fuentes
  privadas sin emitir sus bytes; al 2026-07-25 siguen en 0 entrevistas, 0 incidentes y 0 pilotos
  externos admitidos, por lo que el gate permanece bloqueado.
