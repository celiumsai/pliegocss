...
`pliego-css-lsp` process. It provides the completion, hover, diagnostics, and formatting capabilities
advertised by that server. The extension never downloads or updates native executables.
